...
const schema = z.object({
	...
	ACCESS_TOKEN_SECRET: z
		.string()
		.min(8)
		.default("your-super-secret-access-token-key-which-is-long-enough"),
	REFRESH_TOKEN_SECRET: z
		.string()
		.min(8)
		.default("your-super-secret-refresh-token-key-which-is-long-enough"),
...
class Environment {
	...
	public get<K extends keyof z.infer<typeof schema>>(
		key: K,
	): z.infer<typeof schema>[K] {
		return this.env[key];
	}
}
