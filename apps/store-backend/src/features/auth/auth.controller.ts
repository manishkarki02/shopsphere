...
export const signUpUser: ValidatedRequestHandler<
	typeof import("./validation/auth.validation").signUpSchema
> = async (req, res) => {
...
export const verifyEmail: ValidatedRequestHandler<
	typeof import("./validation/auth.validation").verifyEmailSchema
> = async (req, res) => {
...
export const signIn: ValidatedRequestHandler<
	typeof import("./validation/auth.validation").signInSchema
> = async (req, res) => {
...
export const resendOtpCode: ValidatedRequestHandler<
	typeof import("./validation/auth.validation").resendOtpSchema
> = async (req, res) => {
