...
export const addWishlist: ValidatedRequestHandler<typeof import("./validation/wishlist.validation").addWishlistSchema> = async (req, res) => {
    const user = res.locals.user;
    const wishlist = await wishlistService.addWishlist(user._id, req.body.productId);
...
export const deleteWishlist: ValidatedRequestHandler<typeof import("./validation/wishlist.validation").deleteWishlistSchema> = async (req, res) => {
    const user = res.locals.user;
